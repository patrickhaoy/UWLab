...
CONSTRAINT=${CONSTRAINT:-"h200|l40|l40s|a40|rtx6k"}
...
mkdir -p /mmfs1/gscratch/scrubbed/patyin/slurm_logs
...
#SBATCH --output=/mmfs1/gscratch/scrubbed/patyin/slurm_logs/%x-%j.out
#SBATCH --error=/mmfs1/gscratch/scrubbed/patyin/slurm_logs/%x-%j.err
